var initPhotoSwipeFromDOM = function (gallerySelector) {
    ...
    var addMouseOverChange = function (gallery, currentBig) {
        ...
        gallery.childNodes.forEach(function (el, i) {
            // console.log(el.querySelector('img.img-fluid.image-thumb'))
            el.querySelector('img.img-fluid.image-thumb').addEventListener('mouseover', function (e) {
                currentBig.src = e.target.src;
                console.log(currentBig, i)
    ...
    for (var i = 0, l = galleryElements.length; i < l; i++) {
        ...
        document.querySelector('#openCurrent').onclick = selectBigCurrent.bind(gallery)
        addMouseOverChange(galleryElements[i], document.querySelector('#openCurrent'))
    }
